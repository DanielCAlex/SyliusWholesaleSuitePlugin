...
namespace Tests\SkyBoundTech\SyliusWholesaleSuitePlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\SkyBoundTech\SyliusWholesaleSuitePlugin\Behat\Page\Shop\WelcomePageInterface;
