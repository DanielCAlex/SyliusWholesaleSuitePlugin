...
namespace SyliusWholesaleSuitePlugin\Migrations;
 ...
 */
final class Version20210425231731 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE skyboundtech_quantity_step_rule (id INT AUTO_INCREMENT NOT NULL, ruleset_id INT NOT NULL, name VARCHAR(100) NOT NULL, description VARCHAR(255) DEFAULT NULL, quantity_step INT NOT NULL, scope VARCHAR(255) NOT NULL, enabled TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_3D043F5A5E237E06 (name), INDEX IDX_3D043F5A54F1C144 (ruleset_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE taxon_quantity_step_rule (quantity_step_rule_id INT NOT NULL, taxon_id INT NOT NULL, INDEX IDX_57109310FAD04FF0 (quantity_step_rule_id), INDEX IDX_57109310DE13F470 (taxon_id), PRIMARY KEY(quantity_step_rule_id, taxon_id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE product_quantity_step_rule (quantity_step_rule_id INT NOT NULL, product_id INT NOT NULL, INDEX IDX_6557C904FAD04FF0 (quantity_step_rule_id), INDEX IDX_6557C9044584665A (product_id), PRIMARY KEY(quantity_step_rule_id, product_id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE product_variant_quantity_step_rule (quantity_step_rule_id INT NOT NULL, product_variant_id INT NOT NULL, INDEX IDX_6365DF85FAD04FF0 (quantity_step_rule_id), INDEX IDX_6365DF85A80EF684 (product_variant_id), PRIMARY KEY(quantity_step_rule_id, product_variant_id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE skyboundtech_wholesale_ruleset (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, description VARCHAR(255) DEFAULT NULL, enabled TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_11363A545E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE skyboundtech_quantity_step_rule ADD CONSTRAINT FK_3D043F5A54F1C144 FOREIGN KEY (ruleset_id) REFERENCES skyboundtech_wholesale_ruleset (id)');
        $this->addSql('ALTER TABLE taxon_quantity_step_rule ADD CONSTRAINT FK_57109310FAD04FF0 FOREIGN KEY (quantity_step_rule_id) REFERENCES skyboundtech_quantity_step_rule (id)');
        $this->addSql('ALTER TABLE taxon_quantity_step_rule ADD CONSTRAINT FK_57109310DE13F470 FOREIGN KEY (taxon_id) REFERENCES sylius_taxon (id)');
        $this->addSql('ALTER TABLE product_quantity_step_rule ADD CONSTRAINT FK_6557C904FAD04FF0 FOREIGN KEY (quantity_step_rule_id) REFERENCES skyboundtech_quantity_step_rule (id)');
        $this->addSql('ALTER TABLE product_quantity_step_rule ADD CONSTRAINT FK_6557C9044584665A FOREIGN KEY (product_id) REFERENCES sylius_product (id)');
        $this->addSql('ALTER TABLE product_variant_quantity_step_rule ADD CONSTRAINT FK_6365DF85FAD04FF0 FOREIGN KEY (quantity_step_rule_id) REFERENCES skyboundtech_quantity_step_rule (id)');
        $this->addSql('ALTER TABLE product_variant_quantity_step_rule ADD CONSTRAINT FK_6365DF85A80EF684 FOREIGN KEY (product_variant_id) REFERENCES sylius_product_variant (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE taxon_quantity_step_rule DROP FOREIGN KEY FK_57109310FAD04FF0');
        $this->addSql('ALTER TABLE product_quantity_step_rule DROP FOREIGN KEY FK_6557C904FAD04FF0');
        $this->addSql('ALTER TABLE product_variant_quantity_step_rule DROP FOREIGN KEY FK_6365DF85FAD04FF0');
        $this->addSql('ALTER TABLE skyboundtech_quantity_step_rule DROP FOREIGN KEY FK_3D043F5A54F1C144');
        ...
        $this->addSql('ALTER TABLE product_quantity_step_rule DROP FOREIGN KEY FK_6557C9044584665A');
        ...
        $this->addSql('ALTER TABLE product_variant_quantity_step_rule DROP FOREIGN KEY FK_6365DF85A80EF684');
        ...
        $this->addSql('ALTER TABLE taxon_quantity_step_rule DROP FOREIGN KEY FK_57109310DE13F470');
        ...
        $this->addSql('DROP TABLE skyboundtech_quantity_step_rule');
        $this->addSql('DROP TABLE taxon_quantity_step_rule');
        $this->addSql('DROP TABLE product_quantity_step_rule');
        $this->addSql('DROP TABLE product_variant_quantity_step_rule');
        $this->addSql('DROP TABLE skyboundtech_wholesale_ruleset');
