...
final class WholesaleRuleQuantityStepByProductType extends AbstractResourceType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add(
                ...
                [
                    'multiple' => true,
                    'label' => 'skyboundtech_sylius_wholesale_suite_plugin.ui.wholesale_rules.quantity_step.select_products',
                    'required' => true,
                ]
            )
            ->add('enabled');
